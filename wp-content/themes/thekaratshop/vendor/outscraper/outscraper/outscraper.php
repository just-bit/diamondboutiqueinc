...
class OutscraperClient {
    ...
    public function google_search(
        $query, int $pages_per_query = 1, string $uule = "", string $language = "en", string $region = NULL, string $webhook = NULL
    ) : array {
    ...
    public function google_maps_search(
        $query, string $language = "en", string $region = NULL, int $limit = 400,
    ...
    public function google_maps_reviews(
        $query, string $language = "en", string $region = NULL, int $limit = 1,
     ...
     */
    public function emails_and_contacts($query) : array {
        $params = http_build_query(array(
            "query" => $this->to_array($query),
            "async" => FALSE,
        ));
     ...
     * @return array json result
     */
    public function phones_enricher($query) : array {
        $params = http_build_query(array(
            "query" => $this->to_array($query),
            "async" => FALSE,
        ));
