...
if (!function_exists('woof_print_tax')) {
    ...
    function woof_print_tax($taxonomies, $tax_slug, $terms, $exclude_tax_key, $taxonomies_info, $additional_taxes, $woof_settings, $args, $counter) {
        ...
        if($args['hide_dynamic_empty_pos'] && !empty($args['terms'])){
            $count = 0;
            foreach($args['terms'] as $term){
                if($args['show_count_dynamic'] && $term['count']){
        ...
        <div class="woof_container_inner woof_container_inner_<?php echo esc_attr($primax_class) ?>">
                ...
                switch ($woof_settings['tax_type'][$tax_slug]) {
                    case 'checkbox':
                        ...
                        <div class="catalog-filter__body"
                             <?php if (!empty($woof_container_styles)): ?>style="<?php echo wp_kses_post(wp_unslash($woof_container_styles)) ?>"<?php endif; ?>>
                            <?php
                            woof()->render_html_e(apply_filters('woof_html_types_view_checkbox', get_template_directory() . DIRECTORY_SEPARATOR . 'woof' . DIRECTORY_SEPARATOR . 'views/html_types/checkbox.php'), $args);
                            ?>
                        </div>
                        <?php
                        break;
                    case 'select':
                        ...
                        <div class="<?php echo esc_html($css_classes) ?>">
                            <?php
                            woof()->render_html_e(apply_filters('woof_html_types_view_select', get_template_directory() . DIRECTORY_SEPARATOR . 'woof' . DIRECTORY_SEPARATOR . 'views/html_types/select.php'), $args);
                            ?>
                        </div>
                        <?php
                        break;
                    case 'mselect':
                        ...
                        <div class="<?php echo esc_html($css_classes) ?>">
                            <?php
                            woof()->render_html_e(apply_filters('woof_html_types_view_mselect', get_template_directory() . DIRECTORY_SEPARATOR . 'woof' . DIRECTORY_SEPARATOR . 'views/html_types/mselect.php'), $args);
                            ?>
                        </div>
                        <?php
                        break;
                    ...
                    default:
                            ...
                            <span class="catalog-filer__title active">
                                ...
                                <i>
                                      <svg width="10" height="6" viewBox="0 0 10 6" fill="none"
                                        ...
                                        <path d="M5.3614 4.97384L5.36129 4.97393C5.30956 5.01911 5.25184 5.05256 5.1883 5.07253C5.12836 5.09138 5.06524 5.10028 4.99956 5.09999M5.3614 4.97384L4.63871 4.97393L4.63858 4.97382C4.69038 5.01933 4.74829 5.05292 4.81213 5.07267C4.87166 5.09109 4.93433 5.09995 4.99956 5.09999M5.3614 4.97384L8.90747 1.86795C9.03136 1.75975 9.1 1.62602 9.1 1.47004C9.1 1.31407 9.03136 1.18034 8.90747 1.07214L8.84169 1.14746L8.90757 1.07223C8.78344 0.963549 8.63499 0.909216 8.46723 0.909216C8.30137 0.909216 8.15579 0.9593 8.03713 1.06293L5 3.71516L1.96287 1.06293C1.83903 0.954775 1.6925 0.9 1.5277 0.9C1.36291 0.9 1.21638 0.954775 1.09253 1.06293C0.967355 1.17224 0.9 1.30946 0.9 1.47005C0.9 1.62839 0.962068 1.76323 1.08198 1.86795L4.63846 4.97372L5.3614 4.97384ZM4.99956 5.09999L5 5.00002V5.09999C4.99985 5.09999 4.99971 5.09999 4.99956 5.09999Z"
                                              fill="#1C3557" stroke="#1C3557" stroke-width="0.2"></path>
                                      </svg>
                                    </i>
                                </span>
                            <?php
                        ...
                        <div class="catalog-filter__body <?php echo esc_attr($css_classes) ?>"
                             <?php if (!empty($woof_container_styles)): ?>style="<?php echo wp_kses_post(wp_unslash($woof_container_styles)) ?>"<?php endif; ?>>
                            ...
                            if (!empty(WOOF_EXT::$includes['taxonomy_type_objects'])) {
                                ...
                                foreach (WOOF_EXT::$includes['taxonomy_type_objects'] as $obj) {
                                    ...
                                    if ($is) {
                                        ...
                                        woof()->render_html_e(get_template_directory() . DIRECTORY_SEPARATOR . 'woof' . DIRECTORY_SEPARATOR . 'views/html_types/color.php', $args);
                                        break;
                                    }
                                }
                                ...
                                if (!$is_custom) {
                                    woof()->render_html_e(apply_filters('woof_html_types_view_radio', get_template_directory() . DIRECTORY_SEPARATOR . 'woof' . DIRECTORY_SEPARATOR . 'views/html_types/radio.php'), $args);
                                }
                            } else {
                                woof()->render_html_e(apply_filters('woof_html_types_view_radio', get_template_directory() . DIRECTORY_SEPARATOR . 'woof' . DIRECTORY_SEPARATOR . 'views/html_types/radio.php'), $args);
                            }
            ...
            <input type="hidden" name="woof_t_<?php echo esc_attr($tax_slug) ?>"
                   value="<?php echo esc_html($taxonomies_info[$tax_slug]->labels->name) ?>"/><!-- for red button search nav panel -->
...
<?php if ($autohide): ?>
    <div class='woof_autohide_wrapper' >
        ...
        <div class="woof_auto_show woof_overflow_hidden" style="opacity: 0; height: 1px;">
            ...
            <div data-slug="<?php echo (isset($swoof_slug) ? $swoof_slug : '') ?>" class="woof catalog-filters__main" <?php if (!empty($sid)): ?>data-sid="<?php echo esc_attr($sid); ?>"<?php endif; ?> data-shortcode="<?php echo esc_html(WOOF_REQUEST::isset('woof_shortcode_txt') ? WOOF_REQUEST::get('woof_shortcode_txt') : 'woof') ?>" data-redirect="<?php echo esc_attr($redirect) ?>" data-autosubmit="<?php echo esc_attr($autosubmit) ?>" data-ajax-redraw="<?php echo esc_attr($ajax_redraw) ?>">
                <?php
