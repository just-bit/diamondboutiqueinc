...
?>
        <div class="<?php echo $this->banner_css_class; ?> notice-info notice is-dismissible">
            ...
            <div class="wt-cli-review-footer" style="position: relative;">
                <span class="wt-cli-footer-icon" style="position: absolute;right: 0;bottom: 10px;"><img src="<?php echo plugins_url(basename(plugin_dir_path(WEBTOFFEE_WISHLIST_FILENAME))).$this->webtoffee_logo_url; ?>" style="max-width:100px;"></span>
            </div>
        </div>
    <?php
    }
