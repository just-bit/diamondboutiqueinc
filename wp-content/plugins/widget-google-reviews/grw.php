...
define('BRB_GOOGLE_AVATAR'   , GRW_ASSETS_URL . 'img/google_avatar.png');
define('BRB_FACEBOOK_AVATAR' , GRW_ASSETS_URL . 'img/fb_avatar.png');
define('BRB_YELP_AVATAR'     , GRW_ASSETS_URL . 'img/yelp_avatar.png');
