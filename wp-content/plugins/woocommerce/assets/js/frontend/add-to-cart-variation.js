...
;(function ( $, window, document, undefined ) {
	...
	VariationForm.prototype.onFoundVariation = function( event, variation ) {
		...
		$('.product-style').text('SKU: '+variation.sku);

		if(variation.is_in_stock){
			$('.product-availability').text('In Stock');
			$('.product-availability').removeClass('out-of-stock');
		} else {
			$('.product-availability').text('Out of stock');
			$('.product-availability').addClass('out-of-stock');
		}

		var slide = $('.product-main__slider img[src="'+img_src+'"]').parents('.slick-slide');
		if(slide.length && !slide.hasClass('slick-current')){
			var index = slide.data('slick-index');
			window.changeProductSlide(index);
		}
