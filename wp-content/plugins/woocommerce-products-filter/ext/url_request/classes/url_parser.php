...
class WOOF_URL_PARSER {
    ...
    public function init() {
        ...
        $this->special_filters = array(
            ...
            'product_visibility_instock' => array('product_visibility-instock' => 'instock'),
            'product_visibility_outofstock' => array('product_visibility-outofstock' => 'outofstock'),
            'product_visibility_ends' => array('product_visibility-ends' => 'ends'),
            'product_visibility_expected' => array('product_visibility-expected' => 'expected'),
